...
const Dashboard = () => {
  ...
  const dashboardCards = [
     {title:'Total Cars', value:data.totalCars, icons:assets.carIconColored},
     {title:'Total Bookings', value:data.totalBookings, icons:assets.listIconColored},
     {title:'Pending Bookings', value:data.pendingBookings, icons:assets.cautionIconColored},
     {title:'Confirmed', value:data.completedBookings, icons:assets.listIconColored},
  ]
          ...
          {dashboardCards.map((card, index) => (
             <div key={index} className="flex gap-2 items-center justify-between p-4 rounded-md border border-borderColor" >
                ...
                <div className="flex items-center justify-center w-10 h-10 rounded-full bg-primary/10">
                   <img src={card.icons} alt="" className="h-4 w-4" />
                </div>
            </div>
          ))}
       </div>
