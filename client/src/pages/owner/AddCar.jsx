          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
               ...
               <div className="flex flex-col w-full">
                 ...
                 <select onChange={(e) => setCar({ ...car, category: e.target.value })} className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none"
                    value={car.category} 
                 >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
               ...
               <div className="flex flex-col w-full">
                 ...
                 <select onChange={(e) => setCar({ ...car, transmission: e.target.value })} className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none"
               ...
               <div className="flex flex-col w-full">
                 ...
                 <select onChange={(e) => setCar({ ...car, fuel_type: e.target.value })} className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none"
                    value={car.fuel_type} 
                 >
            ...
            <div className="flex flex-col w-full">
                ...
                <textarea placeholder="e.g. A luxurious SUV with a spacious interior and a powerful engine." value={car.description}  required   rows={5}
                  onChange={(e) =>setCar({ ...car, description: e.target.value }) } className="px-3 py-2 mt-1 border border-borderColor rounded-md outline-none"
                ></textarea>
            </div>
